    ...
    <div class="flex justify-between h-100%">
      ...
      >
        ...
        <div class="mt--150px mx-auto">
          ...
          >
            ...
            <el-form-item>
              <el-checkbox v-model="checkRemember" label="记住我" size="large" />
            </el-form-item>
            <el-form-item>
              <el-button type="primary" @click="onSubmit" :loading="loginLoading" class="w-100%"
                >登录</el-button
              >
            </el-form-item>
          </el-form>
      ...
      <div class="w-50%">
        <div class="w-70px h-50px flex items-center pr-20px cursor-pointer float-right">
          <div class="social-links" data-v-74f3ae96="" data-v-76aa5200="" data-relingo-block="true">
            <a
